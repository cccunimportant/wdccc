...
![圖、馬克士威論物理力線中的四大群方程式](MaxwellEquationOriginal.jpg)
...
![圖、馬克士威方程組表示為八個方程式的版本](MaxwellEquation.jpg)

馬克士威在對於光波是一種電磁現象的推導裏，並沒有使用法拉第電磁感應定律，而是使用方程式(D)來解釋電磁感應作用。

以下是馬克士威原始版的推導過程：

![圖、馬克士威原始版的推導](MaxwellProof.jpg)
...
![圖、黑維塞現代版的推導](MaxwellProofHesswei.jpg)
